...
- 14:30 Hands-on: **toy models for parameter estimation** (Fengler) — [materials](tutorials/day2_bayes_toolkit/mcmc-and-identifiability.ipynb)
...
- 10:00 **BayesFlow** (Radev) — Reading: Radev et al. (2020) · [materials](tutorials/day3_sbi_tools/dmc-bayesflow.ipynb)
- 10:45 Morning coffee / tea
- 11:00 **MCMC sampling for hierarchical Bayesian models** (Turner, Fengler) — Reading: Fengler et al. (2021) · [slides](tutorials/day3_sbi_tools/hierarchical-mcmc-slides.qmd) · [materials](tutorials/day3_sbi_tools/hierarchical-mcmc.ipynb)
...
- 12:00 **Advanced modeling with diffusion methods** (Radev) — Reading: Arruda et al. (2025)
- 13:00 Lunch
- 14:00 Joint modeling workshop: **using a deep neural network to build in covariation** (Nunez) — Reading: Ghaderi-Kangavari et al. (2023) · [materials](tutorials/day4_complex_joint/demo_single_trial_integrative_joint_modeling.ipynb)
